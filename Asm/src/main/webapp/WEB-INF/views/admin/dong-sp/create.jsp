...
<body>
<h1 class="text-center">Thêm Dòng Sản Phẩm</h1>
<div class="col-8 offset-2">
    ...
    <form:form method="POST" action="/admin/dong-sp/add" modelAttribute="dongSp">
        <div class="row mt-3">
            <div class="col-6">
                <label>Mã</label>
                <form:input path="ma" type="text" class="form-control" readonly="true"/>
