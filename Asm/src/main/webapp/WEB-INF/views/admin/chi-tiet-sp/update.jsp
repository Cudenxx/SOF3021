...
<div class="col-8 offset-2">
    ...
    <form:form method="POST" action="/admin/ctsp/update/${ctsp.id}" modelAttribute="ctsp">
        <div class="row">
            <div class=" col-md-4 ">
                <label class="form-label">Năm bảo hành</label>
                <form:input path="namBaoHanh" type="number" class="form-control"  value="${ctsp.namBaoHanh}"/>
                <form:errors path="namBaoHanh" cssClass="text-danger"/>
            </div>

            <div class=" col-md-4 mb-3">
                <label  class="form-label">Số lượng tồn</label>
                <form:input path="soLuongTon" type="number" class="form-control" value="${ctsp.soLuongTon}"/>
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <form:input path="giaNhap" type="number" class="form-control" value="${ctsp.giaNhap}"/>
