...
<c:if test="${ f:length(list.content) != 0 }">
    ...
    <table class="table table-bordered mt-5">
        ...
        <c:forEach var="mauSac" items="${ list.content }" varStatus="status">
            <tr>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <li class="page-item">
                <a class="page-link" href="/admin/mau-sac/index?page=${ list.number - 1 }" tabindex="-1"
                   aria-disabled="true">Previous</a>
            </li>
            <c:forEach begin="0" end="${list.totalPages - 1}" varStatus="loop">
                <li class="page-item">
                    <a class="page-link" href="/admin/mau-sac/index?page=${loop.begin + loop.index}">${loop.begin + loop.index + 1}</a>
                </li>
            </c:forEach>
            <li class="page-item">
                <a class="page-link" href="/admin/mau-sac/index?page=${ list.number + 1 }">Next</a>
            </li>
        </ul>
    </nav>
</c:if>
