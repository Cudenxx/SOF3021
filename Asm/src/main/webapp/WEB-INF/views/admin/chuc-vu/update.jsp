...
<%--    </c:if>--%>
    ...
    <form:form method="POST" action="/admin/chuc-vu/update/${chucVu.id}" modelAttribute="chucVu">
        <div class="row mt-3">
            <div class="col-6">
                <label>Mã</label>
                <form:input path="ma" type="text" class="form-control" value="${chucVu.ma}" readonly="true"/>
                <form:errors path="ma" class="text-danger"/>
            </div>
            <div class="col-6">
                <label>Tên</label>
                <form:input path="ten" type="text" class="form-control" value="${chucVu.ten}"/>
